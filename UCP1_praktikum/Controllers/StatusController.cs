...
namespace UCP1_praktikum.Controllers
{
    public class StatusController : Controller
    {
        ...
        public StatusController(KelurahanContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdStatus,Status1")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdStatus,Status1")] Status status)
        {
